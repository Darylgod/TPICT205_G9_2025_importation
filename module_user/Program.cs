...
using module_user.Middleware;
using module_user.Models;
using System.Text;
using module_user.Middleware;  // Vérifie que c'est bien le bon namespace
...
builder.Services.AddDbContext<BonitaContext>(options =>
    ...
    .AddJwtBearer(options =>
    {
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            IssuerSigningKey = new SymmetricSecurityKey(key),
             ClockSkew = TimeSpan.Zero // Aucune tolérance d'expiration
        };
    });
...
app.UseMiddleware<TokenExpirationMiddleware>(); // 🔥 Ajout du middleware
app.MapControllers();
